    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>
                    <i class="el-icon-lx-cascades"></i>店铺评价
                </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            <el-table :data="tableData" border class="table" ref="multipleTable" header-cell-class-name="table-header">
                <el-table-column prop="cm_date" label="评价时间" align="center"></el-table-column>
                <el-table-column prop="username" label="评价顾客" align="center"></el-table-column>
                <el-table-column prop="message" label="评价内容" width="800" align="center"></el-table-column>
            </el-table>
...
import { GetComment, categoryAdd, userEdit, categoryDelete } from "../api/index";
export default {
    name: "basetable",
    setup() {
