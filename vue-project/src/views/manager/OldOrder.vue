<template>
    <div style="text-align: center;margin: auto">
        <el-table :data="orders" style="width:1300px;border-radius: 15px;margin-top: 20px;padding-left: 5px">
            <el-table-column label="订单号" prop="orderInfo.orderNumber">
            </el-table-column>
            <el-table-column label="下单用户" prop="userInfo.username">
            </el-table-column>
            ...
            <el-table-column label="送达地址" prop="addressInfo.address">
            </el-table-column>
            <el-table-column label="创建时间" prop="orderInfo.createTime">
            </el-table-column>
            <el-table-column label="接单时间" prop="orderInfo.orderTime">
            </el-table-column>
            <el-table-column label="骑手信息" prop="deliveryInfo">
                <template slot-scope="scope">
            ...
            <el-table-column label="订单状态" prop="deliveryInfo">
                <template slot-scope="scope">
